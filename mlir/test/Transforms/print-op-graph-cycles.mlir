...
//  DFG-NEXT:             labeljust = "l";
//  DFG-NEXT:             labelloc = "t";
//  DFG-NEXT:             label = "test.ssacfg_region\l";
...
//  DFG-NEXT:             }
//  DFG-NEXT:             v15 [fillcolor = "0.333333 0.3 0.95", label = "results|<res_1> %1 i32", shape = Mrecord, style = filled];
//  DFG-NEXT:             v11 -> v13[style = invis];
//  DFG-NEXT:             v14 -> v15[style = invis];
//  DFG-NEXT:           }
//  DFG-NEXT:           v16 [fillcolor = "0.166667 0.3 0.95", label = "{{\{\{}}<arg_0> %0|<arg_3> %3}|op2\l|{<res_2> %2 i32}}", shape = Mrecord, style = filled];
//  DFG-NEXT:           v17 [fillcolor = "0.500000 0.3 0.95", label = "{{\{\{}}<arg_0> %0}|op3\l|{<res_3> %3 i32}}", shape = Mrecord, style = filled];
//  DFG-NEXT:         }
//  DFG-NEXT:         v18 [label = " ", shape = plain];
//  DFG-NEXT:         v6 -> v8[style = invis];
//  DFG-NEXT:         v17 -> v18[style = invis];
//  DFG-NEXT:       }
//  DFG-NEXT:     }
//  DFG-NEXT:     v19 [label = " ", shape = plain];
//  DFG-NEXT:     v2 -> v4[style = invis];
//  DFG-NEXT:     v6 -> v19[style = invis];
//  DFG-NEXT:   }
//  DFG-NEXT:   v9:res_0:s -> v9:arg_0:n[style = solid];
//  DFG-NEXT:   v16:res_2:s -> v9:arg_2:n[style = solid];
//  DFG-NEXT:   v9:res_0:s -> v14:arg_0:n[style = solid];
//  DFG-NEXT:   v15:res_1:s -> v14:arg_1:n[style = solid];
//  DFG-NEXT:   v16:res_2:s -> v14:arg_2:n[style = solid];
//  DFG-NEXT:   v17:res_3:s -> v14:arg_3:n[style = solid];
//  DFG-NEXT:   v9:res_0:s -> v16:arg_0:n[style = solid];
//  DFG-NEXT:   v17:res_3:s -> v16:arg_3:n[style = solid];
//  DFG-NEXT:   v9:res_0:s -> v17:arg_0:n[style = solid];
//  DFG-NEXT: }
